...
class KeywordDetailAPI(APIView):
    ...
    @extend_schema(
        responses={200: KeywordResponseSerializer}, tags=["eliza-bot-keyword"]
    )
    def get(self, request, id):
        try:
            ...
            return JsonResponse(
                KeywordResponseSerializer(instance=keyword).data,
                status=status.HTTP_200_OK,
            )
        except Keyword.DoesNotExist:
            return JsonResponse(
                {"message": KEYWORD_EXCEPTION.KEYWORD_NOT_EXIST},
    ...
    @extend_schema(
        request=KeywordUpdateSerializer,
        responses={200: KeywordResponseSerializer},
        tags=["eliza-bot-keyword"],
    )
    def put(self, request, id):
        try:
            ...
            serializer = KeywordUpdateSerializer(
                instance=keyword, data=request.data, partial=True
            )
            if serializer.is_valid():
                updated_eliza_bot = serializer.save()
                return JsonResponse(
                    KeywordResponseSerializer(instance=updated_eliza_bot).data,
                    status=status.HTTP_200_OK,
                )
        except Keyword.DoesNotExist:
            return JsonResponse(
    ...
    def delete(self, request, id):
        try:
            ...
            return JsonResponse(
                {"message": str(KEYWORD_EXCEPTION.KEYWORD_NOT_EXIST)},
...
class KeywordAPI(APIView):
    ...
    @extend_schema(
        responses={200: KeywordResponseSerializer(many=True)},
        tags=["eliza-bot-keyword"],
    )
    def get(self, request, bot_id):
        try:
            ...
            return JsonResponse(
                KeywordResponseSerializer(keywords, many=True).data,
                status=status.HTTP_200_OK,
                safe=False,
            )
    ...
    @extend_schema(
        request=KeywordCreateSerializer,
        responses={200: KeywordResponseSerializer},
        tags=["eliza-bot-keyword"],
    )
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                if bot.owner == request.user:
                    ...
                    return JsonResponse(
                        KeywordResponseSerializer(keyword).data,
                        status=status.HTTP_200_OK,
                    )
                else:
                    return JsonResponse(
