...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        # 'backend.order': 'fas fa-cash-register',
        # 'backend.servicecategory': 'fas fa-tags',
        # 'backend.service': 'fas fa-hand-spock',
        # 'backend.store': 'fas fa-store',
        # 'backend.user': 'fas fa-user',
        # 'backend.voucher': 'fas fa-envelope-open-text',
        # 'backend.orderline': 'fas fa-money-bill',
    },
